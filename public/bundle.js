...
var Grid = function Grid(props) {
    ...
    var rows = props.productData.map(function (row, index) {
        return _react2.default.createElement(
            'div',
            { key: index },
            _react2.default.createElement(Item, { prodData: row })
        );
    });
...
var _Grid = __webpack_require__(/*! ../components/Grid.jsx */ "./src/components/Grid.jsx");
...
var App = function (_Component) {
    ...
    _createClass(App, [{
        ...
        value: function componentDidMount() {
            ...
            var url = "http://develop.plataforma5.la:3000/api/products";
        ...
        value: function render() {
            var productData = this.state.data;

            return _react2.default.createElement(
                'div',
                { className: 'container' },
                _react2.default.createElement(_Grid2.default, { productData: productData })
            );
        }
    }]);
...
var _Api = __webpack_require__(/*! ./containers/Api.jsx */ "./src/containers/Api.jsx");

var _Api2 = _interopRequireDefault(_Api);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

//ReactDom.render(<div>hello migue</div>, document.getElementById("app"))
_reactDom2.default.render(_react2.default.createElement(_Api2.default, null), document.getElementById("app"));
